...
public class Constants {
    ...
    public static HashMap<String, String> getRemoteMsgHeaders() {
        if (remoteMegHeaders == null) {
            ...
            remoteMegHeaders.put(REMOTE_MSG_AUTHORIZATION, "key=AAAAAQe9lkw:APA91bFZnM0H5V91zdqxgcmKjBdld6Rs5GkauYrVkn7r94wLygevIpQjcHqzl3iI7ktHG_VhnLT4r6_JCf18_n7e6Vr5K9ytq0nRnNEUW_gWZys6ESeMVRAnnEuVnRb_rlODqb5-job4");
    ...
    public static HashMap<String, String> getRemoteCallingHeaders() {
        ...
        remoteCallingHeaders.put(Constants.REMOTE_MSG_CALLING_AUTHORIZATION, "key=AAAAAQe9lkw:APA91bFZnM0H5V91zdqxgcmKjBdld6Rs5GkauYrVkn7r94wLygevIpQjcHqzl3iI7ktHG_VhnLT4r6_JCf18_n7e6Vr5K9ytq0nRnNEUW_gWZys6ESeMVRAnnEuVnRb_rlODqb5-job4");
